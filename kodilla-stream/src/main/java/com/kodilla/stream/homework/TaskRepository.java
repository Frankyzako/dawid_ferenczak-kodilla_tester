...
public class TaskRepository {
    ...
    public static List<Task> getTasks() {
        ...
        tasks.add(new Task("Pranie", LocalDate.of(2020, 01, 19), LocalDate.of(2020, 02, 02)));
        tasks.add(new Task("Mycie okien", LocalDate.of(2020, 01, 18), LocalDate.of(2020, 01, 26)));
        tasks.add(new Task("Odsniezanie", LocalDate.of(2020, 01, 18), LocalDate.of(2020, 01, 26)));
        return tasks;
    }
}
